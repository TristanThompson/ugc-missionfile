...
if(_license select 0 == "license_civ_driver" || _license select 0 == "driver") then
{
	if(lrl_licenseGotRemoved) then {
		closeDialog 0;
		hint "Dein Führerschein wurde dir doch von der Polizei entzogen!";
	};
};
