...
// if(playersNumber west < 7) exitWith { hint "Das Zeitschloss des Tresors ist derzeit noch aktiv!"}; <--- TEMP UPDATE TEST!
...
[_shop,_robber,_action]  remoteExec ["TON_fnc_robBankLS",-2];