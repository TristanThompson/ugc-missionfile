...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "stahlschild": {"life_inv_stahlschild"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_stahlschild": {"stahlschild"};
			case "life_inv_panzerglas": {"panzerglas"};
			case "life_inv_junk": {"junk"}; //Justins not-brain junk = müll kakaka kann eh keiner lesen kappa. ahhahahah
