...
switch (_shop) do
{
	...
	case "cop": {["Polizei Austatter",["redgull","coffee","water","donuts","rabbit","pizzabrot","sos","tracker","nothammer","lockpick","defusekit","boltcutter","spikeStrip","fuelF","RoadBlockConc","RoadBlockWood","RoadCone","RoadConeStrip","RoadConeB","RoadConeStripB"]]};
