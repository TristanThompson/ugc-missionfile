...
//DRPG
	case "DRPG_08Suburban_Black": {_light attachto [_veh,[-0.45,0.4,1.48]];};
	case "DRPG_08Suburban_White": {_light attachto [_veh,[-0.45,0.4,1.48]];};
	case "DRPG_08Suburban_blue": {_light attachto [_veh,[-0.45,0.4,1.48]];};
					
	case "DRPG_09Tahoe_Black": {_light attachto [_veh,[-0,0.9,1.348]];};
	case "DRPG_09Tahoe_White": {_light attachto [_veh,[-0,0.9,1.348]];};
	case "DRPG_09Tahoe_blue": {_light attachto [_veh,[-0,0.9,1.348]];};
				
	case "DRPG_11RS3_Black": {_light attachto [_veh,[-1.5,0.1,-0.14]];};
	case "DRPG_11RS3_White": {_light attachto [_veh,[-1.5,0.1,-0.14]];};
	case "DRPG_11RS3_blue": {_light attachto [_veh,[-1.5,0.1,-0.14]];};
					
	case "DRPG_12M5_Black": {_light attachto [_veh,[-0.39,-0.10,0.19]];};
	case "DRPG_12M5_Blue": {_light attachto [_veh,[-0.39,-0.10,0.19]];};
	case "DRPG_12M5_Red": {_light attachto [_veh,[-0.39,-0.10,0.19]];};
					
	case "DRPG_06Victoria_Black": {_light attachto [_veh,[-0.49,0.10,1.459]];};
	case "DRPG_06Victoria_White": {_light attachto [_veh,[-0.49,0.10,1.459]];};
	case "DRPG_06Victoria_blue": {_light attachto [_veh,[-0.49,0.10,1.459]];};
					
	case "DRPG_14Explorer_Black": {_light attachto [_veh,[-0.5,0,0.03]];};
	case "DRPG_14Explorer_White": {_light attachto [_veh,[-0.5,0,0.03]];};
	case "DRPG_14Explorer_blue": {_light attachto [_veh,[-0.5,0,0.03]];};
					
	case "DRPG_15Charger_Black": {_light attachto [_veh,[-0.4, 0.12 , 0.15]];};
	case "DRPG_15Charger_White": {_light attachto [_veh,[-0.4, 0.12 , 0.15]];};
					
	case "DRPG_12Charger_Black": {_light attachto [_veh,[-0.4, 0.12 , 0.15]];};
	case "DRPG_12Charger_White": {_light attachto [_veh,[-0.4, 0.12 , 0.15]];};
					
//MrShounka
	case "shounka_rs6_noir": {_light attachto [_veh,[-0.5, 0.6, 0.81]];};
	case "shounka_rs6_grise": {_light attachto [_veh,[-0.5, 0.6, 0.81]];};
	case "shounka_rs6_bleufonce": {_light attachto [_veh,[-0.5, 0.6, 0.81]];};
					
	case "shounka_a3_rs5_civ_noir": {_light attachto [_veh,[-0.45, -0.1, 0.2]];};
	case "shounka_a3_rs5_civ_grise": {_light attachto [_veh,[-0.45, -0.1, 0.2]];};
	case "shounka_a3_rs5_civ_bleufonce": {_light attachto [_veh,[-0.45, -0.1, 0.2]];};
					
	case "Mrshounka_bmwm6_noir": {_light attachto [_veh,[-0.5, 0, 1.27]];};
	case "Mrshounka_bmwm6_bleufonce": {_light attachto [_veh,[-0.5,  0,  1.27]];};
	case "Mrshounka_bmwm6_grise": {_light attachto [_veh,[-0.5,  0,  1.27]];};
					
	case "Mrshounka_bmwm1_civ_noir": {_light attachto [_veh,[-0.42,0.15,1.33]];};
	case "Mrshounka_bmwm1_civ_bleufonce": {_light attachto [_veh,[-0.42,0.15,1.33]];};
	case "Mrshounka_bmwm1_civ_grise": {_light attachto [_veh,[-0.42,0.15,1.33]];};
					
	case "Mrshounka_raptor2_noir": {_light attachto [_veh,[0, 1.2, 1]];};
					
	case "Mrshounka_mustang_noircase": {_light attachto [_veh,[-0.5, 0, 1.31]];};
	case "Mrshounka_mustang_grise": {_light attachto [_veh,[-0.5, 0, 1.31]];};
					
	case "Mrshounka_Volkswagen_Touareg_noir": {_light attachto [_veh,[0, 1.2, 1]];};
	case "Mrshounka_Volkswagen_Touareg_grise": {_light attachto [_veh,[0, 1.2, 1]];};
					
	case "Mrshounka_cherokee_noir_blanc_mat": {_light attachto [_veh,[0, 0.8, 1.05]];};
	case "Mrshounka_cherokee_noir_bleu_mat": {_light attachto [_veh,[0, 0.8, 1.05]];};
					
	case "Mrshounka_cayenne_p_noir": {_light attachto [_veh,[0,0.83,1.03]];};
					
	case "Mrshounka_hummer_civ_noir": {_light attachto [_veh,[-0.85,0.5,1.50]];};
	case "Mrshounka_hummer_civ_grise": {_light attachto [_veh,[-0.85,0.5,1.50]];};
					
	case "shounka_h2_noir": {_light attachto [_veh,[-0.61,0.88,1]];};
	case "shounka_h2_grise": {_light attachto [_veh,[-0.61,0.88,1]];};
					
	case "Mrshounka_c63_2015_noir": {_light attachto [_veh,[-0.53, -0.28, 0.73]];};
	case "Mrshounka_c63_2015_grise": {_light attachto [_veh,[-0.53, -0.28, 0.73]];};
					
	case "shounka_clk_noir": {_light attachto [_veh,[-0.5, 0.05, 0.87]];};
	case "shounka_clk_grise": {_light attachto [_veh,[-0.5, 0.05, 0.87]];};
					
//Ivory
	case "ivory_m3": {_light attachto [_veh,[-0.39,-0.10,0.35]];};
