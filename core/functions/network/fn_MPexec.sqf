...
if(!(["life_fnc_",_functionName] call BIS_fnc_inString) && {!(["UGC_fnc_",_functionName] call BIS_fnc_inString)}&& {!(["svr_",_functionName] call BIS_fnc_inString)}&& {!(["DB_fnc_",_functionName] call BIS_fnc_inString)} && {!(["TON_fnc_",_functionName] call BIS_fnc_inString)} &&
