...
if(c00l3_b4Nck3h13R < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-c00l3_b4Nck3h13R)] call life_fnc_numberText];};
