...
if(_action) then {
	if(c00l3_b4Nck3h13R < _upgradePrice) exitWith {
		hint parseText format[
			...
			[c00l3_b4Nck3h13R] call life_fnc_numberText,
			[_upgradePrice - c00l3_b4Nck3h13R] call life_fnc_numberText
		];
	};
	__SUB__(c00l3_b4Nck3h13R,_upgradePrice);
