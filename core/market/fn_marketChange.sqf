...
switch(true) do
{
	...
	{
		[0,"News: Interpol hat eine international gesuchte Drogenbande hochgenommen."] remoteExec ["life_fnc_broadcast",-2];
	...
	{
		[0,"News: Öltanker ist gesunken!"] remoteExec ["life_fnc_broadcast",-2];
	...
	{
		[0,"News: China baut das nächste World-Trade-Center."] remoteExec ["life_fnc_broadcast",-2];
	...
	{
		[0,"News: Anleger verlieren vertrauen in Gold."] remoteExec ["life_fnc_broadcast",-2];
	...
	{
		[0,"News: Die Elektroindustrie benötigt weitere Edelmetalle."] remoteExec ["life_fnc_broadcast",-2];
	...
	{
		[0,"News: Die Anleger in Gold verlieren das Vertrauen an den LV-Dollar."] remoteExec ["life_fnc_broadcast",-2];
	...
	{
		[0,"News: Neue, noch billigere Droge, überschwemmt den Drogen Markt."] remoteExec ["life_fnc_broadcast",-2];
	...
	{
		[0,"News: China entdeckt Schildkröten als neue Medizin! Tierschützer sind besorgt!"] remoteExec ["life_fnc_broadcast",-2];
