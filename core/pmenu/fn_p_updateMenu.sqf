...
_mstatus ctrlSetStructuredText parseText format["<t size='1.2px'>$%1</t>",[c00l3_b4Nck3h13R] call life_fnc_numberText];
_mstatus2 ctrlSetStructuredText parseText format["<t size='1.2'>$%1</t>",[v4r14t0X_isTc00L] call life_fnc_numberText];
