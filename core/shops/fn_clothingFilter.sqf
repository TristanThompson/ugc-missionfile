...
_clothes = switch (life_clothing_store) do
{
	...
	case "anzug": {[_selection] call life_fnc_clothing_anzug;};
	case "ausbilder": {[_selection] call life_fnc_clothing_ausbilder;};
	case "taktik": {[_selection] call life_fnc_clothing_taktik;};
};
